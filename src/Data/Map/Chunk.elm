module Data.Map.Chunk exposing
    ( BigChunk(..)
    , SmallChunk(..)
    , bigChunk
    , smallChunk
...
coordChunks : Dict TileCoords SmallChunk
coordChunks =
...
smallChunk : TileCoords -> SmallChunk
smallChunk coords =
    Dict.get coords coordChunks
        |> Maybe.withDefault ArroyoDesert


bigChunk : TileCoords -> BigChunk
bigChunk coords =
    smallToBig (smallChunk coords)


smallToBig : SmallChunk -> BigChunk
smallToBig smallChunk_ =
    case smallChunk_ of
        ArroyoOcean ->
            C1
