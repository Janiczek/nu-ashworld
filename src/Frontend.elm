    ...
    H.div [ HA.id "content" ]
        (case ( model.route, model.world ) of
            ...
            ( Route.Town Route.MainSquare, WorldLoggedIn world ) ->
                withLocation world (townMainSquareView model.expandedQuests)
...
townMainSquareView : Set_.Set Quest.Name -> Location -> WorldLoggedInData -> CPlayer -> List (Html FrontendMsg)
