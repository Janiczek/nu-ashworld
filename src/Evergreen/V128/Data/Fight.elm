module Evergreen.V128.Data.Fight exposing (..)

import Evergreen.V128.Data.Fight.AttackStyle
import Evergreen.V128.Data.Fight.Critical
import Evergreen.V128.Data.Fight.OpponentType
...
type Action
    ...
    | Attack
        { damage : Int
        , attackStyle : Evergreen.V128.Data.Fight.AttackStyle.AttackStyle
        , remainingHp : Int
        , critical : Maybe ( List Evergreen.V128.Data.Fight.Critical.Effect, Evergreen.V128.Data.Fight.Critical.Message )
        , apCost : Int
        }
    | Miss
        { attackStyle : Evergreen.V128.Data.Fight.AttackStyle.AttackStyle
    ...
    | Heal
        { itemKind : Evergreen.V128.Data.Item.Kind.Kind
        , healedHp : Int
        , newHp : Int
        }
    | SkipTurn
...
type Result
    = AttackerWon
        { xpGained : Int
        , capsGained : Int
        , itemsGained : List Evergreen.V128.Data.Item.Item
        }
    | TargetWon
        { xpGained : Int
        , capsGained : Int
...
type alias Info =
    { attacker : Evergreen.V128.Data.Fight.OpponentType.OpponentType
    , target : Evergreen.V128.Data.Fight.OpponentType.OpponentType
    , log : List ( Who, Action )
    , result : Result
