module Evergreen.V112.Data.Vendor.Shop exposing (..)

import Evergreen.V112.Data.Item
import Evergreen.V112.Random.FloatExtra
import SeqDict
...
type alias ShopSpec =
    { caps : Evergreen.V112.Random.FloatExtra.NormalIntSpec
    , stock :
        SeqDict.SeqDict
            Evergreen.V112.Data.Item.UniqueKey
            { maxCount : Int
            }
    }
