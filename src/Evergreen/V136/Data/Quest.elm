module Evergreen.V136.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V136.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V136.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V136.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V136.Data.Vendor.Shop.Shop
        , what : Evergreen.V136.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V136.Data.Vendor.Shop.Shop
    | EndTheGame
