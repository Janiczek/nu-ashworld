module Evergreen.V129.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V129.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V129.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V129.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V129.Data.Vendor.Shop.Shop
        , what : Evergreen.V129.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V129.Data.Vendor.Shop.Shop
    | EndTheGame
