module Evergreen.V124.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V124.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V124.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V124.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V124.Data.Vendor.Shop.Shop
        , what : Evergreen.V124.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V124.Data.Vendor.Shop.Shop
    | EndTheGame
