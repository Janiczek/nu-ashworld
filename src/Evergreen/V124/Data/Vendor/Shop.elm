module Evergreen.V124.Data.Vendor.Shop exposing (..)

import Evergreen.V124.Data.Item
import Evergreen.V124.Random.FloatExtra
import SeqDict
...
type alias ShopSpec =
    { caps : Evergreen.V124.Random.FloatExtra.NormalIntSpec
    , stock :
        SeqDict.SeqDict
            Evergreen.V124.Data.Item.UniqueKey
            { maxCount : Int
            }
    }
