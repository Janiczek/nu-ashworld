module Evergreen.V123.Data.Vendor.Shop exposing (..)

import Evergreen.V123.Data.Item
import Evergreen.V123.Random.FloatExtra
import SeqDict
...
type alias ShopSpec =
    { caps : Evergreen.V123.Random.FloatExtra.NormalIntSpec
    , stock :
        SeqDict.SeqDict
            Evergreen.V123.Data.Item.UniqueKey
            { maxCount : Int
            }
    }
