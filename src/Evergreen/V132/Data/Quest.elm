module Evergreen.V132.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V132.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V132.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V132.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V132.Data.Vendor.Shop.Shop
        , what : Evergreen.V132.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V132.Data.Vendor.Shop.Shop
    | EndTheGame
