module Evergreen.V114.Data.Vendor.Shop exposing (..)

import Evergreen.V114.Data.Item
import Evergreen.V114.Random.FloatExtra
import SeqDict
...
type alias ShopSpec =
    { caps : Evergreen.V114.Random.FloatExtra.NormalIntSpec
    , stock :
        SeqDict.SeqDict
            Evergreen.V114.Data.Item.UniqueKey
            { maxCount : Int
            }
    }
