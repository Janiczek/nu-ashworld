module Evergreen.V135.Data.Fight exposing (..)

import Evergreen.V135.Data.Fight.AttackStyle
import Evergreen.V135.Data.Fight.Critical
import Evergreen.V135.Data.Fight.OpponentType
...
type Action
    ...
    | Attack
        { damage : Int
        , attackStyle : Evergreen.V135.Data.Fight.AttackStyle.AttackStyle
        , remainingHp : Int
        , critical : Maybe ( List Evergreen.V135.Data.Fight.Critical.Effect, Evergreen.V135.Data.Fight.Critical.Message )
        , apCost : Int
        }
    | Miss
        { attackStyle : Evergreen.V135.Data.Fight.AttackStyle.AttackStyle
    ...
    | Heal
        { itemKind : Evergreen.V135.Data.Item.Kind.Kind
        , healedHp : Int
        , newHp : Int
        }
    | SkipTurn
...
type Result
    = AttackerWon
        { xpGained : Int
        , capsGained : Int
        , itemsGained : List Evergreen.V135.Data.Item.Item
        }
    | TargetWon
        { xpGained : Int
        , capsGained : Int
...
type alias Info =
    { attacker : Evergreen.V135.Data.Fight.OpponentType.OpponentType
    , target : Evergreen.V135.Data.Fight.OpponentType.OpponentType
    , log : List ( Who, Action )
    , result : Result
