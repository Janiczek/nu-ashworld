module Evergreen.V135.Data.Vendor.Shop exposing (..)

import Evergreen.V135.Data.Item
import Evergreen.V135.Random.FloatExtra
import SeqDict
...
type alias ShopSpec =
    { caps : Evergreen.V135.Random.FloatExtra.NormalIntSpec
    , stock :
        SeqDict.SeqDict
            Evergreen.V135.Data.Item.UniqueKey
            { maxCount : Int
            }
    }
