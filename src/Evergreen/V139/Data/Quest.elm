module Evergreen.V139.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V139.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V139.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V139.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V139.Data.Vendor.Shop.Shop
        , what : Evergreen.V139.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V139.Data.Vendor.Shop.Shop
    | EndTheGame
