module Evergreen.V119.Data.Vendor.Shop exposing (..)

import Evergreen.V119.Data.Item
import Evergreen.V119.Random.FloatExtra
import SeqDict
...
type alias ShopSpec =
    { caps : Evergreen.V119.Random.FloatExtra.NormalIntSpec
    , stock :
        SeqDict.SeqDict
            Evergreen.V119.Data.Item.UniqueKey
            { maxCount : Int
            }
    }
