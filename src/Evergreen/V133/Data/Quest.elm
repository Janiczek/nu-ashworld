module Evergreen.V133.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V133.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V133.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V133.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V133.Data.Vendor.Shop.Shop
        , what : Evergreen.V133.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V133.Data.Vendor.Shop.Shop
    | EndTheGame
