module Evergreen.V133.Data.WorldData exposing (..)
...
type alias AdminData =
    { worlds :
        Dict.Dict
            Evergreen.V133.Data.World.Name
    ...
    , loggedInPlayers : Dict.Dict Evergreen.V133.Data.World.Name (List Evergreen.V133.Data.Player.PlayerName.PlayerName)
    }


type alias PlayerData =
    { worldName : Evergreen.V133.Data.World.Name
    , description : String
    , startedAt : Time.Posix
    , tickFrequency : Time.Extra.Interval
    , tickPerIntervalCurve : Evergreen.V133.Data.Tick.TickPerIntervalCurve
    , vendorRestockFrequency : Time.Extra.Interval
    , player : Evergreen.V133.Data.Player.CPlayer
    , otherPlayers : List Evergreen.V133.Data.Player.COtherPlayer
    , playerRank : Int
    , vendors : SeqDict.SeqDict Evergreen.V133.Data.Vendor.Shop.Shop Evergreen.V133.Data.Vendor.Vendor
    , questsProgress : SeqDict.SeqDict Evergreen.V133.Data.Quest.Quest Evergreen.V133.Data.Quest.Progress
