module Evergreen.V125.Data.Quest exposing (..)
...
type PlayerReward
    = ItemReward
        { what : Evergreen.V125.Data.Item.Kind.Kind
        , amount : Int
        }
    | SkillUpgrade
        { skill : Evergreen.V125.Data.Skill.Skill
        , percentage : Int
        }
    | PerkReward Evergreen.V125.Data.Perk.Perk
    | CapsReward Int
    | CarReward
...
type GlobalReward
    = NewItemsInStock
        { who : Evergreen.V125.Data.Vendor.Shop.Shop
        , what : Evergreen.V125.Data.Item.Kind.Kind
        , amount : Int
        }
    | Discount
    ...
    | VendorAvailable Evergreen.V125.Data.Vendor.Shop.Shop
    | EndTheGame
