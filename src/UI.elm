...
withTooltip tooltipText element =
    H.div [ HA.class "relative" ]
        ...
        , H.div
            [ HA.class "bg-green-200 text-green-900 px-[2ch] py-4 mt-4 absolute z-[3] left-1/2 -translate-x-1/2 hidden w-max max-w-[26ch] pointer-events-none whitespace-pre-wrap"
